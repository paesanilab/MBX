...
/**
 * @file x2b_A1B2_A1B2_v1x.h
 * @brief Contains the structure of the polynomial holder for symmetry A1B2_A1B2
 */

/**
 * @namespace x2b_A1B2_A1B2_deg5
 * @brief Encloses the structure of the polynomial holder for symmetry A1B2_A1B2
 */
namespace x2b_A1B2_A1B2_deg5 {

class x2b_A1B2_A1B2_v1x {
   public:
