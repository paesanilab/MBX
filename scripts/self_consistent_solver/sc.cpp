...
int main(int argc, char** argv) {
    ...
    // Declare variables
    double e1, e1_perm, e1_ind;
    double e2, e2_perm, e2_ind;
    ...
    for (size_t k = 0; k < 20; k++) {
        ...
        // Calculate E for s2
        e2 = systems[2].Energy(true);
        e2_perm = systems[2].GetPermanentElectrostaticEnergy();
        e2_ind = systems[2].GetInducedElectrostaticEnergy();
        ...
        std::cout << std::setw(5) << "Iter" << std::setw(15) << k << std::setw(20) << "Reference" << std::setw(20)
                  << "S1" << std::setw(20) << "S2" << std::setw(20) << "S1 + S2" << std::endl;

        std::cout << std::setw(20) << "Permanent Elec" << std::setw(20) << e_perm_ref << std::setw(20) << e1_perm
                  << std::setw(20) << e2_perm << std::setw(20) << e1_perm + e2_perm << std::endl;

        std::cout << std::setw(20) << "Induced Elec" << std::setw(20) << e_ind_ref << std::setw(20) << e1_ind
                  << std::setw(20) << e2_ind << std::setw(20) << e1_ind + e2_ind << std::endl;
        std::cout << std::endl;
    }
