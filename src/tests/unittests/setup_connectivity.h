...
#define SETUP_CONNECTIVITY                                                                            \
    ...
    Bond bond1 = Bond(bond_connectivity, bond_indexes, bond_functional_form);                         \
    Angles angle1 = Angles(angle_connectivity, angle_index, angle_functional_form);                   \
    Dihedral dihedral1 = Dihedral(dihedral_connectivity, dihedral_indexes, dihedral_functional_form); \
    Inversion inversion1 = Inversion(inversion_connectivity, inversion_indexes, inversion_functional_form);
