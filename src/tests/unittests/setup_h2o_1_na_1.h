...
#define SETUP_H2O_1_NA_1                                                                                               \
    ...
    std::vector<double> virial_2b = {0.458665,  0.215149,  -0.111635, 0.215149, 0.82197,                               \
                                     0.0469102, -0.111635, 0.0469102, 0.0417556};                                      \
    std::vector<double> virial_elec = {-1.84406, 6.48309, 1.68488, 6.48309, -15.6336,                                  \
                                       -4.7926,  1.68488, -4.7926, -1.36779};                                          \
    std::vector<double> virial_disp = {-0.0898704, 0.176264,  0.0616071, 0.176264,  -0.36551,                          \
                                       -0.123999,  0.0616071, -0.123999, -0.0427444};                                  \
    std::vector<double> virial_buck = {0.079165, -0.16661,  -0.055735, -0.16661, 0.35204,                              \
                                       0.117514, -0.055735, 0.117514,  0.0392727};                                     \
    std::vector<double> virial_ttm_total = {-4.10849, 6.394,   2.56864, 6.394,  -18.2046,                              \
                                            -5.2946,  2.56864, -5.2946, -1.8249};
#endif
