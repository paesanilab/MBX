...
#ifndef UNITTESTS_SETUP_H4_DUMMY_DIHEDRAL_H
#define UNITTESTS_SETUP_H4_DUMMY_DIHEDRAL_H
...
#define SETUP_H4_DUMMY_DIHEDRAL

std::string connectivity = "dihedral";
...
double ff_dihedral_harm_energy = 2.65078;
std::vector<double> ff_dihedral_harm_non_lin_val = {2.6507853601};
double ff_dihedral_harm_grad = -2.30251;
