...
#ifndef UNITTESTS_SETUP_H2O_3_VIRIAL_H
#define UNITTESTS_SETUP_H2O_3_VIRIAL_H

#define SETUP_H2O_3_VIRIAL                                                                          \
    ...
    std::vector<double> virial_3b = {            \
        ...
        -0.03809345,  0.73785134,  0.81031549};  \
    std::vector<double> virial_disp = { \
         -9.84445507, -0.04295674,  0.80621893, \
         -0.04295674, -3.11563098, -4.61445985, \
         0.80621893,  -4.61445985, -7.50791109}; \
    std::vector<double> virial_disp_pbc = { \
         -9.84971319, -0.04303824,  0.8061783 , \
         -0.04303824, -3.11969407, -4.61424474, \
          0.8061783 , -4.61424474, -7.5123088 };  \
    std::vector<double> virial_elec = { \
          -7.97980402,  5.39667782,  7.09870937, \
           5.39667782,  2.6833174 ,   5.058413, \
           7.09870937,  5.058413,   8.18444073 };\
    std::vector<double> virial_elec_pbc = { \
          -8.33417782,  5.68568356,  7.2082218 , \
           5.68568356,  2.40088432,  5.17655354, \
           7.2082218 ,  5.17655354,  8.25317878 }; \
