...
#define SETUP_WATERBOX_3_MBPOL                                                                              \
    ...
    std::vector<double> chg_grad{                                                                           \
        ...
        3.2621767450e-01};                                                                                  \
    std::vector<double> polfac(n_atoms, 0.0);                                                               \
    std::vector<double> pol(n_atoms, 0.0);                                                                  \
    std::vector<std::string> monomer_names(n_monomers, "h2o");                                              \
    std::vector<double> charges{0.0000000000e+00, 1.0527078989e+01, 1.0499141774e+01, -2.1026220763e+01,    \
                                0.0000000000e+00, 1.0507809691e+01, 1.0536990797e+01, -2.1044800488e+01,    \
                                0.0000000000e+00, 1.0543429275e+01, 1.0516118780e+01, -2.1059548055e+01};   \
    ...
    std::vector<double> grad{-7.1325887311e+00, 9.3838029234e+00,  -7.1120493017e+00, -2.6049669131e+00,    \
