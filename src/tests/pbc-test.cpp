...
int main(int argc, char** argv) {
    ...
    for (size_t i = 0; i < systems.size(); i++) {
        ...
        std::cout << std::setprecision(6) << std::scientific << "system[" << std::setfill('.') << std::setw(10) << i
                  << std::setw(12) << "] e1b(nopbc)= " << std::setfill(' ') << std::setw(15) << std::right << e1b
                  << std::setfill(' ') << std::setw(12) << " e1b(pbc)= " << std::setfill(' ') << std::setw(15)
                  << std::right << e1b_pbc << std::setfill(' ') << std::setw(12) << std::right << " kcal/mol"
                  << std::endl;

        std::cout << std::setprecision(6) << std::scientific << "system[" << std::setfill('.') << std::setw(10) << i
                  << std::setw(12) << "] e2b(nopbc)= " << std::setfill(' ') << std::setw(15) << std::right << e2b
                  << std::setfill(' ') << std::setw(12) << " e2b(pbc)= " << std::setfill(' ') << std::setw(15)
                  << std::right << e2b_pbc << std::setfill(' ') << std::setw(12) << std::right << " kcal/mol"
                  << std::endl;

        std::cout << std::setprecision(6) << std::scientific << "system[" << std::setfill('.') << std::setw(10) << i
                  << std::setw(12) << "] e3b(nopbc)= " << std::setfill(' ') << std::setw(15) << std::right << e3b
                  << std::setfill(' ') << std::setw(12) << " e3b(pbc)= " << std::setfill(' ') << std::setw(15)
                  << std::right << e3b_pbc << std::setfill(' ') << std::setw(12) << std::right << " kcal/mol"
                  << std::endl;

#ifdef PRINT_XYZ_PBC_TEST
        std::cout << "\nXYZ no PBC\n " << ats.size() << "\n 0.0 \n";
        for (size_t j = 0; j < ats.size(); j++) {
            std::cout << std::setprecision(6) << std::scientific << std::setw(5) << std::right << ats[j]
                      << std::setw(15) << std::right << xyz[3 * j + 0] << std::setw(15) << std::right << xyz[3 * j + 1]
        ...
        for (size_t j = 0; j < ats.size(); j++) {
            std::cout << std::setprecision(6) << std::scientific << std::setw(5) << std::right << ats[j]
                      << std::setw(15) << std::right << xyz_pbc[3 * j + 0] << std::setw(15) << std::right
                      << xyz_pbc[3 * j + 1] << std::setw(15) << std::right << xyz_pbc[3 * j + 2] << std::endl;
        }
#endif
    ...
    std::vector<double> xyz_w = {0.0,           0.0,          0.0,          0.3233977994, -0.399214478,
                                 -0.8241726072, 0.5584555607, -0.454978538, 0.6418369734};
    ...
    while (d < cutoff + 1.0) {
        xyz_i[2] = d;
        double disp = disp::GetDispersion("h2o", "i", 1, false, xyz_w, xyz_i, grad_w, grad_i, cutoff, false);
        disp_nocutoff.push_back(disp);

        disp = disp::GetDispersion("h2o", "i", 1, false, xyz_w, xyz_i, grad_w, grad_i, cutoff, true);
    ...
    for (size_t i = 0; i < disp_nocutoff.size(); i++) {
        ...
        std::cout << std::setprecision(6) << std::scientific << std::setw(15) << std::right << disp_nocutoff[i];
    }
    ...
    for (size_t i = 0; i < disp_cutoff.size(); i++) {
        ...
        std::cout << std::setprecision(6) << std::scientific << std::setw(15) << std::right << disp_cutoff[i];
    }
    std::cout << std::endl;
    ...
    for (size_t i = 0; i < disp_cutoff.size(); i++) {
        ...
        std::cout << std::setprecision(6) << std::scientific << std::setw(15) << std::right
                  << disp_cutoff[i] - disp_nocutoff[i];
    }
    std::cout << std::endl;
