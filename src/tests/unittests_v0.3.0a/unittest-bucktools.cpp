...
TEST_CASE("GetBuckParams") {
    std::vector<std::pair<std::string, std::string> > pairs = {
        {"f", "h2o"},  {"cl", "h2o"},          {"br", "h2o"},  {"h2o", "i"},
        {"h2o", "li"}, {"h2o", "na"},          {"h2o", "k"},   {"h2o", "rb"},
        {"cs", "h2o"}, {"co2_archive", "h2o"}, {"ch4", "h2o"}, {"co2_archive", "co2_archive"},
        {"ch4", "ch4"}};

    std::vector<std::pair<std::string, std::string> > buck_pairs = {
        {"f", "h2o"},  {"cl", "h2o"},          {"br", "h2o"},  {"i", "h2o"},
        {"li", "h2o"}, {"na", "h2o"},          {"k", "h2o"},   {"rb", "h2o"},
        {"cs", "h2o"}, {"co2_archive", "h2o"}, {"ch4", "h2o"}, {"co2_archive", "co2_archive"},
        {"ch4", "ch4"}};
    ...
    std::vector<std::vector<double> > b_expected = {
        {3.586190000000000e+00, 2.697680000000000e+00},  // {"f","h2o"}
