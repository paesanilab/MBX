...
TEST_CASE("energy3b::get_3b_energy") {
    ...
    SECTION("cl-h2o-h2o") {
        ...
        double energy_expected = 5.1462341984e-01;

        std::vector<double> grad1_expected = {4.4859949089e-15 , 9.4652221531e-01 , -9.5373625586e-02 ,};
        std::vector<double> grad2_expected = {7.2164496601e-16 , -8.8798758353e-01 , -5.0746836790e-01 ,
                                                1.7002223465e+00 , 1.2898820708e-01 , 5.5283906347e-01 ,
                                                -1.7002223465e+00 , 1.2898820708e-01 , 5.5283906347e-01 , };
        std::vector<double> grad3_expected = {-1.3600232052e-15 , 3.7488394575e-01 , -1.6111505928e-01 ,
                                                3.1524458513e-01 , -3.4569749585e-01 , -1.7086053708e-01 ,
                                                -3.1524458513e-01 , -3.4569749585e-01 , -1.7086053708e-01 , };
        std::vector<double> virial_expected = {3.0529930740e+00 , 1.3378187447e-14 , 3.8580250106e-15 ,
                                                1.3378187447e-14 , 2.5260665225e+00 , 8.1492501572e-01 ,
                                                3.8580250106e-15 , 8.1492501572e-01 , 2.0173170909e+00 , };
