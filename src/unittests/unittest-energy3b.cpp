...
TEST_CASE("energy3b::get_3b_energy") {
    ...
    SECTION("f-h2o-h2o") {
        ...
        double expected_energy = 5.0687766455e-01;
    ...
    SECTION("cl-h2o-h2o") {
        ...
        double expected_energy = 5.1462341984e-01;
    ...
    SECTION("br-h2o-h2o") {
        ...
        double expected_energy = 7.4307791410e-01;
    ...
    SECTION("i-h2o-h2o") {
        ...
        double expected_energy = 1.2214518270e+00;
