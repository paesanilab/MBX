...
class Electrostatics {
   ...
   private:
    ...
    void CalculatePermanentElecField3(std::unordered_map<key_precomputed_info, std::vector<double>, key_hash>& precomputedInformation, bool use_ghost = 0);
    ...
    void CalculateDipolesCG3(std::unordered_map<key_precomputed_info, std::vector<double>, key_hash>& precomputedInformation);
    ...
    void CalculateDipoles(std::unordered_map<key_precomputed_info, std::vector<double>, key_hash>& precomputedInformation);
