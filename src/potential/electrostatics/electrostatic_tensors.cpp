...
//    // with alpha,beta = x,y,z
//    // This corresponds to the monomer 1 major index (not vectorizable)
//    ts2_mon1[m*nsites3 + mon1_index] = v0_[m]; // ts2xx
//    ts2_mon1[(m + nmon1)*nsites3 + mon1_index] = v1_[m]; // ts2yx
//    ts2_mon1[(m + nmon12)*nsites3 + mon1_index] = v2_[m]; // ts2zx
//    
//    ts2_mon1[m*nsites3 + mon1_index + nmon2] = v1_[m]; // ts2xy
//    ts2_mon1[(m + nmon1)*nsites3 + mon1_index + nmon2] = v3_[m]; // ts2yy
//    ts2_mon1[(m + nmon12)*nsites3 + mon1_index + nmon2] = v4_[m]; // ts2zy
//
//    ts2_mon1[m*nsites3 + mon1_index + nmon22] = v2_[m]; // ts2xz
//    ts2_mon1[(m + nmon1)*nsites3 + mon1_index + nmon22] = v4_[m]; // ts2yz
//    ts2_mon1[(m + nmon12)*nsites3 + mon1_index + nmon22] = v5_[m]; // ts2zz
//  }
}
