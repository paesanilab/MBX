...
double poly_1b_A1B2_deg4_v1x::eval(const double a[21], const double x[3],
                        double g[3])
{
    const double t1 = a[1];
    const double t2 = a[4];
    ...
    g[0] = ((2.0*t57+t45+t30+t31)*t53+t21+t26+t56+t59)*t53+t12+t20+t52+
t61;
    g[1] = ((2.0*t28+t30+t31)*t25+t21+t26+t33)*t25+t12+t20+t35+((2.0*t45
+t47+t48)*t25+t38+t43+t50+(t44*t53+t47+t48+2.0*t54)*t53)*t53;
    g[2] = ((2.0*t4+t5)*t6+t2+t7)*t6+t1+t9+(t93+t13+t18+(t29*t25+t24+t95
)*t25)*t25+(t93+t13+t18+(t100+2.0*t40+t41)*t25+(t29*t53+t100+t24+t95)*t53)*t53;
