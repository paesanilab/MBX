...
#ifndef MBNRG_2B_A2_A2_DEG6_V1_H
#define MBNRG_2B_A2_A2_DEG6_V1_H
...
/**
 * @file mbnrg_2b_A2_A2_deg6_v1.h
 * @brief Contains the structure of the polynomial holder for symmetry A2_A2
 */
...
struct mbnrg_A2_A2_deg6_v1 {
     ...
     */
    mbnrg_A2_A2_deg6_v1(const std::string mon1, const std::string mon2);

    // Destroys the class
    ~mbnrg_A2_A2_deg6_v1(){};

    // Polynomial for this symmetry
    typedef poly_A2_A2_deg6_v1 polynomial;
