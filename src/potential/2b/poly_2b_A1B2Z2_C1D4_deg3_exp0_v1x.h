...
/**
 * @file poly_2b_A1B2Z2_C1D4_deg3_exp0_v1x.h
 * @brief Contains the structure that allows the evaluation of the polynomial for A1B2Z2_C1D4 symmetry.
 */

/**
 * @namespace x2b_A1B2Z2_C1D4_deg3_exp0
 * @brief Namespace that encloses the A1B2Z2_C1D4 polynomial structure
 */
...
struct poly_2b_A1B2Z2_C1D4_deg3_exp0_v1x {
    ...
    /**
     * @brief Evaluates the polynomial of degree 3 for A1B2Z2_C1D4 symmetry.
     *
     * Given the linear parameters and the value of the polynomial variables, evaluates the polynomial for the
     * A1B2Z2_C1D4 symmetry
     * @param[in] a Double array of 603 elements with the linear parameters of the polynomial
     ...
     *
     * Given the linear parameters and the value of the polynomial variables, evaluates the polynomial for the
     * A1B2Z2_C1D4 symmetry, and calculates the gradients.
     * @param[in] a Double array of 603 elements with the linear parameters of the polynomial
     * @param[in] x Double array of length 38 with the variable values
