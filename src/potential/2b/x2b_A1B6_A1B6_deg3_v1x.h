#ifndef X2B_A1B6_A1B6_DEG3_V1X_H
#define X2B_A1B6_A1B6_DEG3_V1X_H
 
#include "poly_2b_A1B6_A1B6_deg3_v1x.h" 
...
struct x2b_A1B6_A1B6_v1x { 

    x2b_A1B6_A1B6_v1x() {};
    x2b_A1B6_A1B6_v1x(const std::string mon1, const std::string mon2);

    ~x2b_A1B6_A1B6_v1x() {};

    typedef poly_2b_A1B6_A1B6_deg3_v1x polynomial;
