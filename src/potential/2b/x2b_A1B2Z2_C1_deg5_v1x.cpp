...
x2b_A1B2Z2_C1_v1x::x2b_A1B2Z2_C1_v1x(std::string mon1, std::string mon2) {
    ...
    if (mon1 == "h2o" && mon2 == "he") {
        ...
        coefficients = std::vector<double>{1.047619891465483e+01,    // 0
...
double x2b_A1B2Z2_C1_v1x::eval(const double* xyz1, const double* xyz2, double* grad1, double* grad2, const size_t ndim,
    ...
    for (size_t j = 0; j < ndim; j++) {
        ...
        if (virial != 0) {
            (*virial)[0] -= xcrd[0] * grad1[0 + 9 * j] + xcrd[3] * grad1[3 + 9 * j] + xcrd[6] * grad1[6 + 9 * j] +
                            xcrd[9] * grad2[0 + 3 * j];

            (*virial)[1] -= xcrd[0] * grad1[1 + 9 * j] + xcrd[3] * grad1[4 + 9 * j] + xcrd[6] * grad1[7 + 9 * j] +
                            xcrd[9] * grad2[1 + 3 * j];

            (*virial)[2] -= xcrd[0] * grad1[2 + 9 * j] + xcrd[3] * grad1[5 + 9 * j] + xcrd[6] * grad1[8 + 9 * j] +
                            xcrd[9] * grad2[2 + 3 * j];

            (*virial)[4] -= xcrd[1] * grad1[1 + 9 * j] + xcrd[4] * grad1[4 + 9 * j] + xcrd[7] * grad1[7 + 9 * j] +
                            xcrd[10] * grad2[1 + 3 * j];

            (*virial)[5] -= xcrd[1] * grad1[2 + 9 * j] + xcrd[4] * grad1[5 + 9 * j] + xcrd[7] * grad1[8 + 9 * j] +
                            xcrd[10] * grad2[2 + 3 * j];

            (*virial)[8] -= xcrd[2] * grad1[2 + 9 * j] + xcrd[5] * grad1[5 + 9 * j] + xcrd[8] * grad1[8 + 9 * j] +
                            xcrd[11] * grad2[2 + 3 * j];
