#ifndef MBNRG_2B_A1B3_A1B3_DEG5_V1_H
#define MBNRG_2B_A1B3_A1B3_DEG5_V1_H
...
#include "poly_2b_A1B3_A1B3_deg5_v1.h" 
...
struct mbnrg_A1B3_A1B3_deg5_v1 {
    mbnrg_A1B3_A1B3_deg5_v1() {};
    mbnrg_A1B3_A1B3_deg5_v1(const std::string mon1, const std::string mon2);

    ~mbnrg_A1B3_A1B3_deg5_v1() {};

    typedef poly_A1B3_A1B3_deg5_v1 polynomial;
