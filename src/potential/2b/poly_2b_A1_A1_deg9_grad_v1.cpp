...
/**
 * @file poly_2b_A1_A1_deg9_grad_v1.cpp
 * @brief Contains the implementation of the polynomials with gradients for symmetry A1_A1
 */
...
double poly_A1_A1_deg9_v1::eval(const double x[1], const double a[9], double g[1]) {
    const double t1 = a[0];
    const double t2 = a[1];
    const double t3 = a[2];
    const double t4 = a[3];
