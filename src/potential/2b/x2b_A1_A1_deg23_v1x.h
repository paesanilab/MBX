#ifndef X2B_A1_A1_DEG23_V1X_H
#define X2B_A1_A1_DEG23_V1X_H
...
struct x2b_A1_A1_v1x { 

    x2b_A1_A1_v1x() {};
    x2b_A1_A1_v1x(const std::string mon1, const std::string mon2);

    ~x2b_A1_A1_v1x() {};

    typedef poly_2b_A1_A1_deg23_v1x polynomial;
