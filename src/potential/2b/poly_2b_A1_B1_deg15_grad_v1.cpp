...
double poly_A1_B1_deg15_v1::eval(const double x[1],
            const double a[15],
                  double g[1]) {
    const double t1 = a[0];
    const double t2 = a[1];
    ...
    g[0] = (((((((((((((2.0*t15+t16)*t17+t13+t18)*t17+t12+t20)*t17+t11+
t22)*t17+t10+t24)*t17+t9+t26)*t17+t8+t28)*t17+t7+t30)*t17+t6+t32)*t17+t5+t34)*
t17+t4+t36)*t17+t3+t38)*t17+t2+t40)*t17+t1+t42;
    return (t1+t42)*t17;
}
