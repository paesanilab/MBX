...
#ifndef X2B_A1B2Z2_C1D2_V1X_H
#define X2B_A1B2Z2_C1D2_V1X_H
...
/**
 * @file x2b_A1B2Z2_C1D2_v1x.h
 * @brief Contains the structure of the polynomial holder for symmetry A1B2Z2_C1D2
 */

/**
 * @namespace x2b_A1B2Z2_C1D2_deg4
 * @brief Encloses the structure of the polynomial holder for symmetry A1B2Z2_C1D2
 */
namespace x2b_A1B2Z2_C1D2_deg4 {

class x2b_A1B2Z2_C1D2_v1x {
   public:
     ...
     */
    x2b_A1B2Z2_C1D2_v1x(const std::string mon1, const std::string mon2);

    // Destroys the class
    ~x2b_A1B2Z2_C1D2_v1x(){};

    // Polynomial for this symmetry
    typedef poly_2b_A1B2Z2_C1D2_deg4_v1x polynomial;
