...
mbnrg_A1_A1_deg9_v1::mbnrg_A1_A1_deg9_v1(const std::string mon1, const std::string mon2) {
    ...
    if (mon1 == "ar" and mon2 == "ar") {
        coefficients = std::vector<double> {
            -8.527086309441063e-03, // 0
             5.323541412508981e-03, // 1
            -9.736134588804710e-03, // 2
             1.759981510382065e-03, // 3
               -5.654544659572944e-04, // 4
                1.229930478536050e-04, // 5
               -1.080013299260559e-05, // 6
                4.245842542904677e-07, // 7
               -8.139647735207268e-09}; // 8
       m_k_x_inter_A_A_0 =  6.530518546915380e-01;     // A^(-1))
       m_d_x_inter_A_A_0 =  5.767421156393051e+00;     // A^(-1))
       m_ri =  7.000000000000000e+00; // A
       m_ro =  9.000000000000000e+00; // A
...
double mbnrg_A1_A1_deg9_v1::eval(const double *xyz1, const double *xyz2, double *grad1, double *grad2 , const size_t n, std::vector<double> *virial) {
    std::vector<double> energies(n,0.0);
    std::vector<double> energies_sw(n,0.0);
