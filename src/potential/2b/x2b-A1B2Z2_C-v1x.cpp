...
x2b_h2o_ion_v2x::x2b_h2o_ion_v2x(std::string mon1, std::string mon2) {
    ...
    // Fluoride
    if (mon1 == "h2o" && mon2 == "f") {
        twobodyfit = std::vector<double>{1.578462246457094e+02,   // 0
    ...
    // Chloride
    if (mon1 == "h2o" && mon2 == "cl") {
        twobodyfit = std::vector<double>{1.992108786573811e+02,   // 0
    ...
    // Bromide
    if (mon1 == "h2o" && mon2 == "br") {
        twobodyfit = std::vector<double>{1.980059421531693e+01,    // 0
    ...
    // Iodide
    if (mon1 == "h2o" && mon2 == "i") {
        twobodyfit = std::vector<double>{3.652412748351991e+01,    // 0
        ...
        k_HH_intra = 1.690714146830114e-01;                        // A^(-1)
        k_OH_intra = 2.565281925640369e-01;                        // A^(-1)
        k_XH_coul = 3.956462144870756e-01;                         // A^(-1)
        k_XO_coul = 1.176634967561005e+00;                         // A^(-1)
        k_xlp_main = 6.948494465864904e-01;                        // A^(-1)
        d_HH_intra = 1.880727200923587e+00;                        // A^(-1)
        d_OH_intra = 6.152749653490401e-01;                        // A^(-1)
        d_XH_coul = 6.785414811821708e+00;                         // A^(-1)
        d_XO_coul = 6.997789772262751e+00;                         // A^(-1)
        d_xlp_main = 6.318749319126379e+00;                        // A^(-1)
        in_plane_gamma = -9.721486914088159e-02;
        out_of_plane_gamma = 9.859272078406150e-02;
    ...
    if (mon1 == "h2o" && mon2 == "ar") {
        twobodyfit = std::vector<double>{3.796947325001375e+00,   // 0
                                         -9.337807122376579e+01,  // 1
                                         -3.701171984985329e+01,  // 2
                                         2.129178229246008e+01,   // 3
                                         1.433723643111778e+00,   // 4
                                         1.226107409450266e+00,   // 5
                                         5.532769284730666e+00,   // 6
                                         -3.726956060207173e+01,  // 7
                                         -1.410738970389528e+01,  // 8
                                         1.588771484054221e+00,   // 9
                                         9.550414074763292e+00,   // 10
                                         4.447198487639882e+00,   // 11
                                         -2.582214966264196e+01,  // 12
                                         3.046615137545802e+01,   // 13
                                         1.802868918386436e+01,   // 14
                                         7.933000614575244e+01,   // 15
                                         -7.721057975131464e+00,  // 16
                                         -1.200272498870871e+00,  // 17
                                         5.168869099928072e+01,   // 18
                                         1.750967428523358e+01,   // 19
                                         1.911519669422629e-01,   // 20
                                         -3.768752386309910e+01,  // 21
                                         -1.126286374658523e+00,  // 22
                                         -2.209235684174656e+01,  // 23
                                         -6.457562543582532e+00,  // 24
                                         6.031182391072822e+00,   // 25
                                         1.677749186049158e+00,   // 26
                                         -5.933806673941932e-01,  // 27
                                         -4.024267726240415e+01,  // 28
                                         -2.053446679221003e+01,  // 29
                                         5.705678329680961e+00,   // 30
                                         -8.620250359911059e-02,  // 31
                                         3.648601744196217e+00,   // 32
                                         4.569027133929849e+00,   // 33
                                         5.227040604298688e+00,   // 34
                                         2.108059084504507e-01,   // 35
                                         -2.456735709510126e+01,  // 36
                                         -3.900133905872925e-01,  // 37
                                         -4.298670776301583e+00,  // 38
                                         -1.736986136205807e+00,  // 39
                                         1.773515684979401e-01,   // 40
                                         -1.097233661119125e+01,  // 41
                                         6.583245953989533e+00,   // 42
                                         3.695062680950444e+01,   // 43
                                         6.420970832368802e+00,   // 44
                                         -7.174025507759308e+00,  // 45
                                         -6.197240561133623e+00,  // 46
                                         1.172533671402778e+00,   // 47
                                         -2.369435433369102e+01,  // 48
                                         -8.509682065207651e+00,  // 49
                                         -5.675863928065543e-01,  // 50
                                         1.500740464310730e+01,   // 51
                                         -3.903113718087690e-01,  // 52
                                         6.857368615387299e+00,   // 53
                                         -2.842185638469320e+01,  // 54
                                         7.470972144955729e+01,   // 55
                                         -2.419687282443657e+00,  // 56
                                         -3.828420377526457e+00,  // 57
                                         6.097785660096101e-02,   // 58
                                         -8.571057977103752e-01,  // 59
                                         -4.707013753805852e+01,  // 60
                                         2.468447008525588e+01,   // 61
                                         -1.060559993976161e+01,  // 62
                                         6.114342360240014e+01,   // 63
                                         8.798352391345440e-02,   // 64
                                         1.470755562437663e+01,   // 65
                                         1.859852367102046e+00,   // 66
                                         -1.681638064074790e-02,  // 67
                                         -7.908418047500270e-03,  // 68
                                         9.172552190584264e-02,   // 69
                                         -6.458821422713294e-02,  // 70
                                         2.883119040457728e-02,   // 71
                                         -1.850517859569547e-02,  // 72
                                         -4.341289614779145e+00,  // 73
                                         7.308308092496492e-02,   // 74
                                         -1.860988066304689e+00,  // 75
                                         -2.877052476967972e-03,  // 76
                                         -1.375931374052603e+01,  // 77
                                         -1.256017409782228e-01,  // 78
                                         -4.941478163947923e+00,  // 79
                                         -9.641815166835878e-01,  // 80
                                         -3.357089866710663e+00,  // 81
                                         -5.999310273848373e-03,  // 82
                                         1.503049091409664e-01,   // 83
                                         -3.063674862022225e-01,  // 84
                                         -2.580594637661030e-02,  // 85
                                         1.016879925397561e+00,   // 86
                                         1.335237004552792e+01,   // 87
                                         1.145155661453862e+00,   // 88
                                         -6.078764504364528e+00,  // 89
                                         -2.869345888775363e+01,  // 90
                                         3.603263104372375e-02,   // 91
                                         -6.277465173100643e+00,  // 92
                                         -1.063042083546648e+01,  // 93
                                         1.152305637391176e+01,   // 94
                                         -1.758192730382486e-01,  // 95
                                         1.075523948534240e+01,   // 96
                                         -7.985777516260439e-02,  // 97
                                         4.064800887091383e-03,   // 98
                                         -3.321937451748638e-02,  // 99
                                         8.280915411196095e+01,   // 100
                                         1.541581550646282e+00,   // 101
                                         -7.825470380542877e-02,  // 102
                                         -2.884392294561744e-03,  // 103
                                         -8.168722621143718e+01,  // 104
                                         -9.825474771730944e-02,  // 105
                                         4.084326539011413e+01,   // 106
                                         -3.041563858783873e-01,  // 107
                                         1.668336619393427e+01,   // 108
                                         3.078044755094812e-02,   // 109
                                         9.396952294930934e-02,   // 110
                                         2.274172719125434e+00,   // 111
                                         9.062430698790369e-02,   // 112
                                         -4.999321442500393e-01,  // 113
                                         -2.162425117673951e-02,  // 114
                                         2.021131606636779e-02,   // 115
                                         1.477738472452804e+00,   // 116
                                         -6.842492835556203e-04,  // 117
                                         4.710885592269098e-03,   // 118
                                         1.214131327060496e-01,   // 119
                                         -1.924000659508604e-01,  // 120
                                         2.012228697574866e-02,   // 121
                                         5.413038574313533e-01,   // 122
                                         -4.659194747944712e-03,  // 123
                                         2.433602371334099e+00,   // 124
                                         6.507297960811809e-03,   // 125
                                         -8.667755762629379e-03,  // 126
                                         -2.767576807144341e-01,  // 127
                                         6.503904876615728e-03,   // 128
                                         -6.020511234004387e+01,  // 129
                                         -4.257062012389282e-02,  // 130
                                         2.243112564221590e+00,   // 131
                                         -2.526770524283965e-04,  // 132
                                         -9.649645553294084e-03,  // 133
                                         4.774389009778186e-03,   // 134
                                         4.723691711173831e+01,   // 135
                                         6.195547588712096e-02,   // 136
                                         3.532954975323919e-02,   // 137
                                         5.315681552437494e-02,   // 138
                                         9.737416909422326e+00,   // 139
                                         -5.635199907145523e-02,  // 140
                                         -5.219632858361496e-03,  // 141
                                         1.299772232873717e+01,   // 142
                                         -9.363738292126936e+00,  // 143
                                         5.391938476287376e-03,   // 144
                                         -1.032563292873208e-01,  // 145
                                         -7.815332792239407e-03,  // 146
                                         5.111552483618312e-02,   // 147
                                         2.512168867812681e+00,   // 148
                                         2.469746440742837e+00,   // 149
                                         -6.216094635911026e-03,  // 150
                                         -4.084113866743112e-04,  // 151
                                         2.039899270291486e-01,   // 152
                                         -5.309771148197288e-01,  // 153
                                         -9.428364960119450e-01,  // 154
                                         -8.689246431062142e-03,  // 155
                                         -9.075534648638170e+00,  // 156
                                         -2.400476074107281e+01,  // 157
                                         1.089359345581248e+00,   // 158
                                         2.798981672045233e-01,   // 159
                                         4.409791101486669e-02,   // 160
                                         -1.216398760388676e-01,  // 161
                                         -9.535556842556669e+00,  // 162
                                         1.667714172416934e+01,   // 163
                                         5.694781115419454e-01,   // 164
                                         -2.576060586822622e-01,  // 165
                                         5.999644180977821e-01,   // 166
                                         -2.771874140195083e-01,  // 167
                                         4.190657452585852e-01,   // 168
                                         -2.026689732926532e+00,  // 169
                                         -7.193259753781642e-02,  // 170
                                         1.735202310568701e+01,   // 171
                                         -9.806208626158764e+00,  // 172
                                         2.984984671615184e-01,   // 173
                                         -5.819292266355382e-04,  // 174
                                         -3.688237748164834e+00,  // 175
                                         1.531437600526832e-01,   // 176
                                         -3.394993675925258e-02,  // 177
                                         1.186015490933650e-01,   // 178
                                         1.522384543151339e-02,   // 179
                                         1.004644304334408e-01,   // 180
                                         1.118975627988744e+01,   // 181
                                         -6.516370286445930e-03,  // 182
                                         -5.493098324553779e-02,  // 183
                                         1.020242506107759e-02,   // 184
                                         -3.248351190498324e-02,  // 185
                                         -7.527889119771706e-05,  // 186
                                         -4.573823072405279e-02,  // 187
                                         2.908710082096527e-03,   // 188
                                         2.639657273308845e-05,   // 189
                                         1.296654977678691e-02,   // 190
                                         -4.315052158732771e-01,  // 191
                                         1.197887847784882e-02,   // 192
                                         1.179599308394909e-04,   // 193
                                         -6.115194455698680e-02,  // 194
                                         -7.278061670493080e+00,  // 195
                                         1.190007759679890e-05,   // 196
                                         -3.291001837543173e-02,  // 197
                                         -2.287223248497282e-01,  // 198
                                         -4.046110957995935e-02,  // 199
                                         3.937465043612576e+00,   // 200
                                         7.553510420057068e-03,   // 201
                                         -8.254299067654383e-03,  // 202
                                         4.035289806236416e-05,   // 203
                                         -6.173345439293981e-05,  // 204
                                         4.938158219072618e-03,   // 205
                                         4.080236192364675e+00,   // 206
                                         -5.796951138382089e-04,  // 207
                                         6.193843344719161e-03,   // 208
                                         -4.439189116717909e-03,  // 209
                                         -2.176310156217464e-04,  // 210
                                         1.072880097434703e-04,   // 211
                                         4.360886736041307e-03,   // 212
                                         -1.579656843600137e-02,  // 213
                                         -1.276455080557007e-03,  // 214
                                         -3.274302346402419e-05,  // 215
                                         1.913518177295352e-04,   // 216
                                         3.446810553367268e-03,   // 217
                                         -4.005274393008885e-03,  // 218
                                         -5.121503360402142e-03,  // 219
                                         3.725111490800583e-03,   // 220
                                         6.749174100449175e-03,   // 221
                                         5.644423608445548e-04,   // 222
                                         4.016146433267569e-03,   // 223
                                         1.893681552239388e-01,   // 224
                                         9.928468471056527e-02,   // 225
                                         3.119363202499108e-04,   // 226
                                         -1.096459850053562e-04,  // 227
                                         9.739146910922866e-04,   // 228
                                         -3.567529753377418e-02,  // 229
                                         -4.926461733590701e-05,  // 230
                                         6.328439756763818e-02,   // 231
                                         -1.287522730642983e-04,  // 232
                                         9.241162880039909e-05,   // 233
                                         -6.486220596100226e+00,  // 234
                                         -1.034153953663050e-04,  // 235
                                         6.662026186218721e-04,   // 236
                                         -6.161337849667812e-04,  // 237
                                         2.534809873094551e+00,   // 238
                                         3.590920909090591e-03,   // 239
                                         -4.699752164562166e+00,  // 240
                                         -1.512021527416283e-03,  // 241
                                         2.255667287977007e-04,   // 242
                                         1.356811077031698e+01,   // 243
                                         -9.383623194845667e-04,  // 244
                                         1.131912863292594e-04,   // 245
                                         1.792581782464130e-05,   // 246
                                         1.843109109036039e-03,   // 247
                                         1.266667785448772e-04,   // 248
                                         -1.611443105830256e-04,  // 249
                                         1.765070127047913e-04,   // 250
                                         -4.753780893135691e-06,  // 251
                                         -8.056057363648692e-02,  // 252
                                         -2.116128779272499e-01,  // 253
                                         -2.038470857211346e-01,  // 254
                                         4.213554343604767e-05,   // 255
                                         1.420284459746602e-04,   // 256
                                         4.473318993361630e-03,   // 257
                                         -3.827487153519354e-05,  // 258
                                         -3.693851816353330e-01,  // 259
                                         1.080343961705955e-01,   // 260
                                         3.325349815093276e-03,   // 261
                                         1.022101939503559e-01,   // 262
                                         2.953286569326029e-05,   // 263
                                         3.630302093078812e-04,   // 264
                                         -1.654604750187350e+01,  // 265
                                         3.380023802186113e-01,   // 266
                                         -4.255943917580866e-02,  // 267
                                         -9.311278439517326e-03,  // 268
                                         -9.180280957487011e-05,  // 269
                                         -3.455416007815578e-01,  // 270
                                         -4.651806505126790e-05,  // 271
                                         -4.710846597522327e-02,  // 272
                                         4.071370975215335e-03,   // 273
                                         -8.972730391809130e-05,  // 274
                                         -1.475452925696786e-04,  // 275
                                         7.971680314997536e-01,   // 276
                                         -9.415812500082510e-05,  // 277
                                         -1.248429748399945e-03,  // 278
                                         2.467269042886018e+01,   // 279
                                         9.403258690635559e-02,   // 280
                                         3.232753430779991e+01,   // 281
                                         -5.008569525262751e+00,  // 282
                                         -5.989645790516743e-04,  // 283
                                         1.374194600107843e-01,   // 284
                                         2.276146519649730e-06,   // 285
                                         9.916309258071500e-04,   // 286
                                         2.333937311270090e-02,   // 287
                                         4.733849935819628e-03,   // 288
                                         -1.134199041388520e-03,  // 289
                                         -1.790966006794473e-04,  // 290
                                         -1.724728225980377e-02,  // 291
                                         -4.800807336358612e-05,  // 292
                                         4.306326080960569e-06,   // 293
                                         1.081052610066872e-03,   // 294
                                         -3.730714356922870e+01,  // 295
                                         2.885612359749781e-04,   // 296
                                         2.517616073143971e-02,   // 297
                                         -3.444024296600425e-01,  // 298
                                         -1.908278754657282e-01,  // 299
                                         1.367421500420835e-04,   // 300
                                         -6.256245254545032e+00,  // 301
                                         2.034193927473032e-03,   // 302
                                         -7.724652418865914e-04,  // 303
                                         1.341798950886586e-02,   // 304
                                         -2.492159837474494e-02,  // 305
                                         -4.619296489417505e+00,  // 306
                                         -3.046320131052984e-04,  // 307
                                         1.045816996651070e-02,   // 308
                                         4.732768193712719e-04,   // 309
                                         -4.927863207541541e-04,  // 310
                                         -1.452845854933162e-06,  // 311
                                         -7.116825800788203e-04,  // 312
                                         -1.666937578255766e-02,  // 313
                                         -8.569717421837744e-06,  // 314
                                         5.702267166269230e-03,   // 315
                                         -2.994492695532032e-04,  // 316
                                         2.103050870272204e-05,   // 317
                                         3.180277788330678e-02,   // 318
                                         2.452344396295530e-01,   // 319
                                         1.996902018911655e-03,   // 320
                                         -8.263334921939131e-06,  // 321
                                         1.100510956633250e-03,   // 322
                                         -9.729770576649604e-06,  // 323
                                         1.639274862151979e+00,   // 324
                                         1.828835591749590e-04,   // 325
                                         8.609631176355073e-04,   // 326
                                         1.630948883899868e+00,   // 327
                                         -9.198787578545439e-02,  // 328
                                         -3.465175921311542e-05,  // 329
                                         1.244762081579863e-04,   // 330
                                         5.012092405430722e-05,   // 331
                                         6.145301179585873e-02,   // 332
                                         4.915567454590177e-05,   // 333
                                         2.249258390318333e-01,   // 334
                                         1.926713019590449e-04,   // 335
                                         4.879446146335404e-04,   // 336
                                         -6.854509961953421e-04,  // 337
                                         -3.218234875598713e-04,  // 338
                                         -1.316271630025024e-04,  // 339
                                         3.552414827031648e-02,   // 340
                                         -6.700445376273918e-02,  // 341
                                         -9.736028683373398e-04,  // 342
                                         1.575230847015774e-02,   // 343
                                         -3.631332637757096e-03,  // 344
                                         3.687816496537611e-05,   // 345
                                         2.865338667421605e-03,   // 346
                                         -6.231487795307112e-04,  // 347
                                         -3.107864012771799e-03,  // 348
                                         7.557336634516016e-05,   // 349
                                         1.693054113950649e-03,   // 350
                                         -1.784691177543512e-03,  // 351
                                         -1.056713470695519e+00,  // 352
                                         2.604438099000309e-01,   // 353
                                         2.185104762386151e-04,   // 354
                                         -1.558336748150933e-02,  // 355
                                         3.422694839476208e-04,   // 356
                                         -1.249303315046636e-04,  // 357
                                         -5.706147876802314e-04,  // 358
                                         1.922036611567639e-05,   // 359
                                         2.410391325150581e-03,   // 360
                                         1.637836670430739e-02,   // 361
                                         -9.269125429799084e-05,  // 362
                                         8.563106254912813e-04,   // 363
                                         2.486210419616308e-02,   // 364
                                         -1.080922881698086e-04,  // 365
                                         -2.934162775779941e-05,  // 366
                                         -2.369142038617421e-01,  // 367
                                         2.615528282687072e-01,   // 368
                                         -1.694945155384760e-01,  // 369
                                         -5.956002086747690e-04,  // 370
                                         3.890598131021502e+00,   // 371
                                         -2.588844677895457e-02,  // 372
                                         -4.045560878435019e-05,  // 373
                                         7.005558494543306e-02,   // 374
                                         -3.503939462800290e-03,  // 375
                                         3.468513783699491e-04,   // 376
                                         1.983387894806769e-02,   // 377
                                         -9.041567617644816e-02,  // 378
                                         3.666277703186333e-03,   // 379
                                         -3.473459859125566e-01,  // 380
                                         5.352937469230135e-02,   // 381
                                         1.023343461665032e-04,   // 382
                                         -1.580904853382203e-03,  // 383
                                         -8.170740100236015e-03,  // 384
                                         1.786250098005570e-02,   // 385
                                         4.153308950676514e-05,   // 386
                                         -8.901290364664940e-01,  // 387
                                         1.717504349998214e-05,   // 388
                                         9.189731919207071e-04,   // 389
                                         3.536938378837653e-02,   // 390
                                         -3.046251257234969e-04,  // 391
                                         3.578696281062098e-04,   // 392
                                         -1.885542270412923e-03,  // 393
                                         2.582949013509547e-03,   // 394
                                         -1.586333531557192e-04,  // 395
                                         -1.363506873254082e-01,  // 396
                                         3.742892295145023e-05,   // 397
                                         4.390924816469157e-04,   // 398
                                         -1.015652497811654e-03,  // 399
                                         -4.431038297350367e-03,  // 400
                                         -9.405393778344198e-01,  // 401
                                         7.704974041829963e-05,   // 402
                                         3.614666460090401e-04,   // 403
                                         -5.958061229105776e-07,  // 404
                                         3.840760313466476e-04,   // 405
                                         -4.777285750873835e-03,  // 406
                                         -1.247952323549553e+00,  // 407
                                         -1.769109428884626e-03,  // 408
                                         4.482108495166865e-05,   // 409
                                         1.034151811057977e-01,   // 410
                                         -2.353512961948378e-04,  // 411
                                         -1.596004580865231e-07,  // 412
                                         9.820382072898533e-02,   // 413
                                         -1.351862627083767e-02,  // 414
                                         -4.533690431861057e-02,  // 415
                                         -5.021187512726422e-03,  // 416
                                         -2.520282859462199e+01,  // 417
                                         1.026396200768338e-01,   // 418
                                         2.504279390070941e-01,   // 419
                                         1.319882649586499e-02,   // 420
                                         2.565810538072359e-04,   // 421
                                         4.358064691970542e-05,   // 422
                                         1.599695052374154e-03,   // 423
                                         3.311337524387298e-01,   // 424
                                         7.517395868861395e-05,   // 425
                                         2.067157854679301e-05,   // 426
                                         -2.716715610314493e-02,  // 427
                                         3.389441120954078e-04};  // 428

        k_HH_intra = 5.488480459442671e-02;  // A^(-1)
        k_OH_intra = 1.084639537278723e+00;  // A^(-1)
        k_XH_coul = 4.833661126370331e-01;   // A^(-1)
        k_XO_coul = 1.091335377571354e+00;   // A^(-1)
        k_xlp_main = 1.204658113104207e+00;  // A^(-1)
        d_HH_intra = 5.543585954758034e+00;  // A^(-1)
        d_OH_intra = 3.522132754929846e+00;  // A^(-1)
        d_XH_coul = 6.944636540850912e+00;   // A^(-1)
        d_XO_coul = 5.336546803828633e+00;   // A^(-1)
        d_xlp_main = 5.349908015396529e+00;  // A^(-1)
        in_plane_gamma = -9.721486914088159e-02;
        out_of_plane_gamma = 9.859272078406150e-02;
        r2i = 7.000000000000000e+00;  // A
        r2f = 8.000000000000000e+00;  // A
    }
}
