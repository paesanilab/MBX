...
#ifndef POLY_2B_MBNRG_A1_A1_DEG9_H
#define POLY_2B_MBNRG_A1_A1_DEG9_H

/**
 * @file poly_2b_A1_A1_deg9_v1.h
 * @brief Contains the structure of the polynomial for symmetry A1_A1
 */
...
struct poly_A1_A1_deg9_v1 {
    ...
    /**
     * @brief Evaluates the polynomial of degree 9 for A1_A1 symmetry.
     *
     * Given the linear parameters and the value of the polynomial variables,
     * evaluates the polynomial for the A1_A1 symmetry.
...
#endif  // POLY_2B_MBNRG_A1_A1_DEG9_H
