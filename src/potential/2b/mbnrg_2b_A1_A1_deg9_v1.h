...
#ifndef MBNRG_2B_A1_A1_DEG9_V1_H
#define MBNRG_2B_A1_A1_DEG9_V1_H
...
/**
 * @file mbnrg_2b_A1_A1_deg9_v1.h
 * @brief Contains the structure of the polynomial holder for symmetry A1_A1
 */

/**
 * @namespace mbnrg_A1_A1_deg9
 * @brief Encloses the structure of the polynomial holder for symmetry A1_A1
 */
...
struct mbnrg_A1_A1_deg9_v1 {
     ...
     */
    mbnrg_A1_A1_deg9_v1(const std::string mon1, const std::string mon2);

    // Destroys the class
    ~mbnrg_A1_A1_deg9_v1(){};

    // Polynomial for this symmetry
    typedef poly_A1_A1_deg9_v1 polynomial;
