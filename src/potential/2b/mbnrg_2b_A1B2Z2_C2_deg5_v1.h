...
#ifndef MBNRG_2B_A1B2Z2_C2_DEG5_V1_H
#define MBNRG_2B_A1B2Z2_C2_DEG5_V1_H
...
/**
 * @file mbnrg_2b_A1B2Z2_C2_deg5_v1.h
 * @brief Contains the structure of the polynomial holder for symmetry A1B2Z2_C2
 */
...
struct mbnrg_A1B2Z2_C2_deg5_v1 {
    // Creates an empty class
    mbnrg_A1B2Z2_C2_deg5_v1(){};
     ...
     */
    mbnrg_A1B2Z2_C2_deg5_v1(const std::string mon1, const std::string mon2);

    // Destroys the class
    ~mbnrg_A1B2Z2_C2_deg5_v1(){};

    // Polynomial for this symmetry
    typedef poly_A1B2Z2_C2_deg5_v1 polynomial;
