...
struct pimd : public necklace {
    ...
    void init1(size_t natoms, size_t nbeads, double T,
               double* mass, double* cartpos, mt19937&);
...
inline const double& pimd::time0() const
{
    return m_time0;
}
...
inline const double& pimd::temperature() const
{
    return m_T;
}
...
inline const double& pimd::TI_lambda() const
{
    return m_TI_lambda;
}
